...
module.exports = {
  activate() {
    ...
    this.disposables = new CompositeDisposable(
      ...
      atom.config.observe('inline-git-diff.statusBarIconOnly', value => statusBar.setIconOnly(value))
    )
  },
  ...
  consumeStatusBar(service) { statusBar.init(service) } // prettier-ignore
}
