...
module.exports = class GitDiffDetailsView extends View {
  ...
  getHunkAtCursorRow() {
    ...
    const selectedHunk = this.diffDetailsDataManager.getHunkAtLine(lineNumber)
    const isSameHunk = !!this.previousSelectedHunk && selectedHunk === this.previousSelectedHunk
  ...
  updateDiffDetailsDisplay() {
    if (this.showDiffDetails) {
      ...
      console.log({selectedHunk, isSameHunk})
      if (selectedHunk) {
