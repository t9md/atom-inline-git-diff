...
module.exports = class DiffDetailsDataManager {
  ...
  getSelectedHunk(lineNumber) {
    if (this.selectedHunk == null || this.selectedHunkInvalidated || !this.liesBetween(this.selectedHunk, lineNumber)) {
      this.updateLineDiffDetails()
      this.updateSelectedHunk(lineNumber)
    }
  ...
  updateSelectedHunk(lineNumber) {
    this.selectedHunk = null

    if (this.lineDiffDetails != null) {
      for (let hunk of this.lineDiffDetails) {
        if (this.liesBetween(hunk, lineNumber)) {
